 ...
 * <b>aggregation:</b> defines whether the association end is constrained by <tt>aggregate</tt> semantics.<br>
 * <b>isNavigable:</b> specifies whether the association end supports navigation.<br>
 * <b>isChangeable:</b> specifies whether the association end can be updated (using the generated APIs).
 * 
 * <p><b>References</b><br>
 * None.
 * 
 ...
 * <b>EndsMustBeUnique</b> (C-40): The <tt>isUnique</tt> flag in an AssociationEnd’s multiplicity must be true.<br>
 * <b>CannotHaveTwoOrderedEnds</b> (C-41): An Association cannot have two AssociationEnds marked as <tt>ordered</tt>.<br>
 * <b>CannotHaveTwoAggregateEnds</b> (C-42): An Association cannot have an aggregation semantic specified for both AssociationEnds.<br>
 *
 */
